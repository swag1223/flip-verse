...
THREE.FBXLoader = (function () {
  ...
  FBXTreeParser.prototype = {
    ...
    setModelTransforms: function (model, modelNode) {
      ...
      if ("RotationOrder" in modelNode)
        transformData.eulerOrder = parseInt(modelNode.RotationOrder.value);
      ...
      sceneGraph.traverse(function (child) {
        if (child.isMesh) {
          if (
            ...
            sceneGraph.traverse(function (child) {
              if (child.isMesh) {
                if (child.material.uuid === matUuid && child.uuid !== uuid)
                  sharedMat = true;
              }
            });
  ...
  GeometryParser.prototype = {
    ...
    genMorphGeometry: function (
      ...
      //   preTransform.applyToBufferAttribute(positionAttribute);
      positionAttribute.applyMatrix3(preTransform);
